...
class _ChatbotWidgetState extends State<ChatbotWidget> with WidgetsBindingObserver {
  ...
  void _fetchEvents() {
    _databaseReference.onValue.listen((event) {
      // Get the data from the event snapshot and cast it to a Map
      final data = event.snapshot.value as Map<dynamic, dynamic>;
      // Update the state with the new list of events
      setState(() {
        // Map each entry in the data to an Event object and convert to a list
  ...
  if (_model.textController!.text.isNotEmpty) {
    ...
    String messageTOrespons="start answering :"+userMessage+".if you need more detales for the answer take a look in my events , Here is my upcoming events, from schedule calendar "+eventsString;
